...
class MailServiceTest {
    ...
    void sendAttachmentsMail() throws Exception {
        Mail mail = new Mail();
        mail.setTo("2447186375@qq.com");
        mail.setSubject("测试带附件的邮件");
        mail.setContent("带附件的邮件内容");
        // 本地文件
        File file1 = new File("D:\\ideaprojects\\spring-boot-course\\spring-boot-config\\src\\main\\java\\top\\zmy\\boot\\config\\img\\1.jpg");
        File file2 = new File("D:\\ideaprojects\\spring-boot-course\\spring-boot-config\\src\\main\\java\\top\\zmy\\boot\\config\\img\\2.jpg");
